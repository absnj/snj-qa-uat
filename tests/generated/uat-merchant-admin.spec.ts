...
test.describe('UAT matrix role: Merchant Admin', () => {
  ...
  test.describe('Feature tests', () => {
    ...
    test('Merchant Admin views deal list [Configuration | read]', async ({ page, context }) => {
      // Role: Merchant Admin
    ...
    test('Merchant Admin creates deal - success [Configuration | create]', async ({ page, context }) => {
      // Role: Merchant Admin
      // Feature/Module: Configuration
      // Operation: create
    ...
    test('Merchant Admin updates deal - success [Configuration | update]', async ({ page, context }) => {
      // Role: Merchant Admin
      // Feature/Module: Configuration
      // Operation: update
    ...
    test('Merchant Admin can manage deals [Configuration | manage]', async ({ page, context }) => {
      // Role: Merchant Admin
      // Feature/Module: Configuration
      // Operation: manage
